        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="number" name="processing_charge" class="form-control" step="any" min="0" value="{{ $receive->processing_charge }}">
            </div>
            ...
            <table class="table table-bordered" id="itemsTable">
              ...
              <tbody id="itemsBody">
                ...
                <tr class="item-row">
                  ...
                  <td><input type="number" name="items[{{ $i }}][quantity_output]" class="form-control" step="any" min="0" value="{{ $item->quantity_output }}"></td>
  ...
  $('#addRowBtn').on('click', function () {
    ...
    const row = $(`
      <tr class="item-row">
        ...
        <td><input type="number" name="items[${idx}][quantity_output]" class="form-control" step="any" min="0" value="0"></td>
        <td><button type="button" class="btn btn-sm btn-outline-danger remove-row">&times;</button></td>
      </tr>
    `);
